...
class SingleTest01 extends FunSuite {
...
class SingleTest02 extends FunSuite {

    test("Add new bank account") {
        val bank: ActorRef = BankManager.createBank("2002")
        val (accountRef, account) = SingleTestHelper.createBankAccount("2002", 1000)
        assert(account.accountId == "1001" && account.getBalanceAmount == 1000)
    }

}

class SingleTest03 extends FunSuite {
    ...
    test("Valid transaction within same bank, accounts should have correct balance.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("2003", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("2003", 1000)

        implicit val timeout = Timeout(5 seconds)

        account1.transferTo(account2.accountId, 200)

        SingleTestHelper.waitUntilAllTransactionsAreCompleted(List(account1, account2))
        assert(account1.getBalanceAmount == 800 && account2.getBalanceAmount == 1200)
    }
}

class SingleTest04 extends FunSuite {

    test("Valid transaction between two different banks, accounts should have correct balance.") {
        val (bank1Ref, bank1): (ActorRef, Bank) = SingleTestHelper.createBank("2010")
        val (bank2Ref, bank2): (ActorRef, Bank) = SingleTestHelper.createBank("2011")

        val (accountRef1, account1) = SingleTestHelper.createBankAccount("2010", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("2011", 1000)
...
class SingleTest05 extends FunSuite {

    test("Valid transaction between two different banks, sender transaction list should have the correct status information.") {
        val (bank1Ref, bank1): (ActorRef, Bank) = SingleTestHelper.createBank("2015")
        val (bank2Ref, bank2): (ActorRef, Bank) = SingleTestHelper.createBank("2016")

        val (accountRef1, account1) = SingleTestHelper.createBankAccount("2015", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("2016", 1000)
...
class SingleTest06 extends FunSuite {

    test("Two valid transactions back and forth between two banks, account balances should be correct.") {
        val (bank1Ref, bank1): (ActorRef, Bank) = SingleTestHelper.createBank("6000")
        val (bank2Ref, bank2): (ActorRef, Bank) = SingleTestHelper.createBank("6001")

        val (accountRef1, account1) = SingleTestHelper.createBankAccount("6000", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("6001", 1000)
...
class SingleTest07 extends FunSuite {
    ...
    test("Four valid transactions back and forth between two banks, account balances should be correct.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("7000", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("7001", 1000)
...
class SingleTest08 extends FunSuite {
    ...
    test("Several transactions between two banks and three accounts, all transaction lists should hold correct status information, and account balances should be correct.") {
        val (bank1Ref, bank1): (ActorRef, Bank) = SingleTestHelper.createBank("8000")
        val (bank2Ref, bank2): (ActorRef, Bank) = SingleTestHelper.createBank("8001")

        val (accountRef1, account1) = SingleTestHelper.createBankAccount("8000", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("8001", 1000)
        val (accountRef3, account3) = SingleTestHelper.createBankAccount("8001", 1000)
        ...
        SingleTestHelper.waitUntilAllTransactionsAreCompleted(List(account1, account2, account3))
...
class SingleTest09 extends FunSuite {
    ...
    test("Failed transactions should lead to correct status information in all transaction lists, and no balances should be affected.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("9000", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("9000", 1000)
...
class SingleTest10 extends FunSuite {
    ...
    test("Valid transactions within one bank, transaction list should have correct status information.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("1000", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("1000", 1000)
...
class SingleTest11 extends FunSuite {
    ...
    test("Invalid transaction within one bank, transaction lists should have correct status information.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("1100", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("1100", 1000)
...
class SingleTest12 extends FunSuite {
    ...
    test("Invalid transactions within one bank, account balances should not be affected.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("1200", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("1200", 1000)
...
class SingleTest13 extends FunSuite {
...
class SingleTest14 extends FunSuite {
    ...
    test("Valid transactions between two banks using full account address, account balances should be correct. Also, sending a BalanceRequest to an account should yield the correct balance.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("1400", 1000)
        val (accountRef2, account2) = SingleTestHelper.createBankAccount("1401", 1000)
        val (accountRef3, account3) = SingleTestHelper.createBankAccount("1401", 1000)
...
class SingleTest15 extends FunSuite {
    ...
    test("Several valid transactions between several accounts in several banks. All information should be correct.") {
        ...
        for (bank <- 1 to numberOfBanks) {
            ...
            for (account <- 1 to numberOfAccountsPerBank) {
                val a: (ActorRef, Account) = SingleTestHelper.createBankAccount(s"150$bank", 1000)
                accounts = a :: accounts
            }
        }
        ...
        SingleTestHelper.waitUntilAllTransactionsAreCompleted(accountsList)
...
/*class SingleTest16 extends FunSuite {
    ...
    test("Transaction to a non-existing bank should fail, and account balance should not be affected and transaction list should hold correct status information.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("1600", 1000)

        account1.transferTo("99998888", 200)

        SingleTestHelper.waitUntilAllTransactionsAreCompleted(List(account1))
...
class SingleTest17 extends FunSuite {
    ...
    test("Transaction to a non-existing account should fail, account balance should not be affected and transaction list should hold correct status information.") {
        ...
        val (accountRef1, account1) = SingleTestHelper.createBankAccount("1700", 1000)
